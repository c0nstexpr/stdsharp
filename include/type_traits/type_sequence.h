...
namespace stdsharp::type_traits
{
    namespace details
    {
        ...
        {
            using seq = ::stdsharp::type_traits::type_sequence<Types...>;
        ...
        struct unique_type_sequence
        {
            ...
            static constexpr auto filtered_indices = []<size_t... I>(const ::std::index_sequence<I...>)
            {
                ...
                const auto f = [&]<::std::size_t J>(
                    const ::stdsharp::type_traits::constant<J>
                ) noexcept
                {
                    if(is_valid<J>())
                    {
                ...
                (f(::stdsharp::type_traits::constant<I>{}), ...);
        ...
        concept type_sequence_nothrow_predicate =
            ((::stdsharp::concepts::nothrow_invocable_r<
                Func,
                bool,
                ::std::invoke_result_t<Proj, ::std::type_identity<Types>>>)&&...);
        ...
        struct from_regular_value_sequence<
            ::stdsharp::type_traits::regular_value_sequence<Values...>> :
            ::std::type_identity<::stdsharp::type_traits:: //
                                 regular_type_sequence<typename decltype(Values)::type...>>
        {
        };

        template<typename Seq>
        using from_regular_value_sequence_t = typename ::stdsharp::type_traits::details:: //
            from_regular_value_sequence<Seq>::type;
    }

    template<typename... Types>
    struct type_sequence :
        private ::stdsharp::type_traits::value_sequence<
            ::stdsharp::type_traits::static_const_v< // clang-format off
                ::stdsharp::type_traits::type_constant<Types>
            >...
        > // clang-format on
    {
    private:
        using base = ::stdsharp::type_traits::value_sequence<
            ::stdsharp::type_traits::static_const_v< // clang-format off
                ::stdsharp::type_traits::type_constant<Types>
            >...
        >; // clang-format on
        ...
        using from_value_seq_t =
            ::stdsharp::type_traits::details::from_regular_value_sequence_t<Seq>;
    ...
    public:
        ...
        template<std::size_t I>
        static constexpr auto get = ::stdsharp::functional::constructor<get_t<I>>;

        template<std::size_t... OtherInts>
        using indexed_t = ::stdsharp::type_traits::regular_type_sequence<get_t<OtherInts>...>;

        template<typename Seq>
        using indexed_by_seq_t =
            typename ::stdsharp::type_traits::take_value_sequence<Seq>::template apply_t<indexed_t>;
        ...
        using append_t = ::stdsharp::type_traits::regular_type_sequence<Types..., Others...>;
        ...
        template<typename... Others>
        using append_front_t = ::stdsharp::type_traits::regular_type_sequence<Others..., Types...>;
        ...
        struct insert
        {
            ...
            using type = from_value_seq_t< //
                typename base::template insert_t<
                    Index,
                    ::stdsharp::type_traits::type_constant_v<Others>... // clang-format off
                >
            >; // clang-format on
        };
    ...
    public:
        ...
        template<::std::size_t Index, typename Other>
        using replace_t = from_value_seq_t<typename base::template replace_t<
            Index,
            ::stdsharp::type_traits::type_identity_v<Other>>>;
    ...
    using to_regular_type_sequence_t =
        typename ::stdsharp::type_traits::take_type_sequence<Sequence>::as_sequence_t;

    template<typename Sequence>
    using to_type_sequence_t = typename ::stdsharp::type_traits:: //
        take_type_sequence<Sequence>::as_type_sequence_t;

    template<typename... Types>
    using reverse_type_sequence_t =
        typename ::stdsharp::type_traits::details::reverse_type_sequence_t<Types...>::type;

    template<typename... Types>
    using unique_type_sequence_t =
        typename ::stdsharp::type_traits::details::unique_type_sequence<Types...>::type;
}
...
namespace std
{
    ...
    struct tuple_element<I, ::stdsharp::type_traits::type_sequence<Types...>> :
        ::std::type_identity<
            typename ::stdsharp::type_traits::type_sequence<Types...>::template get_t<I>>
    {
    };
    ...
    struct tuple_size<::stdsharp::type_traits::type_sequence<Types...>> :
        ::stdsharp::type_traits::index_constant<
            ::stdsharp::type_traits::type_sequence<Types...>::size>
    {
    };
}
