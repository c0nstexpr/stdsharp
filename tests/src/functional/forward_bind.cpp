...
SCENARIO("forward bind front", "[functional]") // NOLINT
{
    ...
    {
        const auto func = forward_bind_front(
            [](const t0& obj) -> const t0& { return obj; },
            const_obj
        );

        const auto back_func = forward_bind_back(
            [](int, const t0& obj) -> const t0& { return obj; },
            const_obj
        );
    ...
    {
        auto func = forward_bind_front(
            [](t0&& obj) -> t0 { return obj; },
            t0{}
        );

        auto back_func = forward_bind_back(
            [](int, t0&& obj) -> t0 { return obj; },
            t0{}
        );
    ...
    {
        auto func =
            forward_bind_front([](t0& obj) -> t0& { return obj; }, obj);

        auto back_func =
            forward_bind_back([](int, t0& obj) -> t0& { return obj; }, obj);
